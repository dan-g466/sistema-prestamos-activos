    ...
    public function model(array $row)
    {
        ...
        if ($this->categoria_id) {
            ...
            if (!$categoriaNombre) {
                ...
                } elseif (Str::contains($n, ['papel', 'esfero', 'lapiz', 'cuaderno', 'marcador', 'tinta', 'resma', 'pegante', 'tijeras', 'borrador', 'grapadora', 'cosedora', 'perforadora', 'cinta', 'regla', 'folder', 'carpeta', 'legajador', 'resaltador', 'bisturi'])) {
                    $categoriaNombre = 'Papelería';
                } elseif (Str::contains($n, ['balon', 'pesa', 'malla', 'uniforme', 'raqueta', 'taco', 'cronometro', 'gym', 'deporte', 'mancuerna', 'colchoneta', 'aro', 'lazo', 'pito', 'peto', 'pelota', 'bicicleta', 'carpa', 'barra', 'entrenamiento', 'trotadora', 'eliptica'])) {
