...
<body class="bg-[#f8fafc] font-sans antialiased selection:bg-green-100 selection:text-green-800" x-data="{ sidebarOpen: window.innerWidth >= 1024 }" @resize.window="sidebarOpen = window.innerWidth >= 1024">
    <div class="flex h-screen overflow-hidden bg-[#f8fafc]">
        ...
        <aside class="bg-[#39A900] w-64 flex-shrink-0 flex flex-col fixed inset-y-0 z-50 transition-all duration-300 shadow-[10px_0_30px_-15px_rgba(0,0,0,0.2)] border-r border-white/10"
            ...
            <div class="p-6 pb-2">
                <div class="group flex flex-col items-center gap-4 transition-all duration-300">
                    <div class="group-hover:scale-105 transition-all duration-500">
                        <img src="{{ asset('img/logo.png') }}" alt="Logo SENA" class="h-20 w-auto object-contain brightness-0 invert">
                    </div>
                    <div class="text-center">
                        ...
                        <div class="h-0.5 w-12 bg-white mx-auto mt-2 rounded-full transform group-hover:w-20 transition-all duration-500"></div>
                    </div>
                </div>
            </div>
            ...
            <nav class="flex-1 mt-2 px-3 space-y-0.5 overflow-y-auto custom-scrollbar">
                ...
                <a href="{{ route('admin.dashboard') }}"
                   class="flex items-center gap-3 px-3 py-1.5 rounded-xl text-[12px] font-bold transition-all duration-300 group
                          {{ request()->routeIs('admin.dashboard') ? 'bg-white text-[#39A900] shadow-xl shadow-black/5 scale-[1.02]' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                ...
                <a href="{{ route('admin.elementos.index') }}"
                   class="flex items-center gap-3 px-3 py-1.5 rounded-xl text-[12px] font-bold transition-all duration-300 group
                          {{ request()->routeIs('admin.elementos.*') ? 'bg-white text-[#39A900] shadow-xl shadow-black/5 scale-[1.02]' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                ...
                <a href="{{ route('admin.categorias.index') }}"
                   class="flex items-center gap-3 px-3 py-1.5 rounded-xl text-[12px] font-bold transition-all duration-300 group
                          {{ request()->routeIs('admin.categorias.*') ? 'bg-white text-[#39A900] shadow-xl shadow-black/5 scale-[1.02]' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                ...
                <a href="{{ route('admin.elementos.import') }}"
                   class="flex items-center gap-3 px-3 py-1.5 rounded-xl text-[12px] font-bold transition-all duration-300 group
                          {{ request()->routeIs('admin.elementos.import') ? 'bg-white text-[#39A900] shadow-xl shadow-black/5 scale-[1.02]' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                    <svg class="w-4 h-4 flex-shrink-0 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 13h6m-3-3v6m-9 1V7a2 2 0 012-2h6l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg>
                ...
                <a href="{{ route('admin.prestamos.index') }}"
                   class="flex items-center gap-3 px-3 py-1.5 rounded-xl text-[12px] font-bold transition-all duration-300 group
                          {{ request()->routeIs('admin.prestamos.index') ? 'bg-[#00324D] text-white shadow-xl shadow-black/10 scale-[1.02]' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                ...
                <a href="{{ route('admin.prestamos.vencidos') }}"
                   class="flex items-center gap-3 px-3 py-1.5 rounded-xl text-[12px] font-bold transition-all duration-300 group
                          {{ request()->routeIs('admin.prestamos.vencidos') ? 'bg-white text-rose-600 shadow-xl shadow-black/5 scale-[1.02]' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                ...
                <a href="{{ route('admin.usuarios.index') }}"
                   class="flex items-center gap-3 px-3 py-1.5 rounded-xl text-[12px] font-bold transition-all duration-300 group
                          {{ request()->is('admin/usuarios*') ? 'bg-white text-[#39A900] shadow-xl shadow-black/5 scale-[1.02]' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                ...
                <a href="{{ route('admin.sanciones.index') }}"
                   class="flex items-center gap-3 px-3 py-1.5 rounded-xl text-[12px] font-bold transition-all duration-300 group
                          {{ request()->routeIs('admin.sanciones.*') ? 'bg-white text-rose-600 shadow-xl shadow-black/5 scale-[1.02]' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                ...
                <a href="{{ route('admin.reportes.index') }}"
                   class="flex items-center gap-3 px-3 py-1.5 rounded-xl text-[12px] font-bold transition-all duration-300 group
                          {{ request()->routeIs('admin.reportes.*') ? 'bg-white text-[#39A900] shadow-xl shadow-black/5 scale-[1.02]' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                ...
                <a href="{{ route('admin.movimientos.index') }}"
                   class="flex items-center gap-3 px-3 py-1.5 rounded-xl text-[12px] font-bold transition-all duration-300 group
                          {{ request()->routeIs('admin.movimientos.*') ? 'bg-white text-[#39A900] shadow-xl shadow-black/5 scale-[1.02]' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                ...
                <a href="{{ route('admin.backups.index') }}"
                   class="flex items-center gap-3 px-3 py-1.5 rounded-xl text-[12px] font-bold transition-all duration-300 group
                          {{ request()->routeIs('admin.backups.*') ? 'bg-white text-[#39A900] shadow-xl shadow-black/5 scale-[1.02]' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
            ...
            <!-- Logout Button -->
            <div class="p-3 mt-auto border-t border-white/10 bg-black/5">
        ...
        <div class="flex-1 flex flex-col overflow-hidden relative lg:ml-0" :class="sidebarOpen && window.innerWidth >= 1024 ? 'lg:ml-64' : ''">
            ...
            {{-- Header Balanced --}}
            <header class="h-14 bg-white/80 backdrop-blur-md sticky top-0 z-30 flex items-center justify-between px-4 md:px-6 border-b border-slate-100 shadow-sm">
                <div class="flex items-center gap-3">
                    {{-- Hamburger --}}
                    <button @click="sidebarOpen = !sidebarOpen"
                            class="p-2 rounded-xl text-slate-400 hover:text-[#39A900] hover:bg-slate-50 transition-all border border-slate-100 active:scale-90">
                    ...
                    <div class="hidden md:flex flex-col">
                        <h3 class="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none mb-0.5">Sistema de Préstamos</h3>
                        <p class="text-xs font-bold text-[#00324D]">{{ now()->isoFormat('dddd, D [de] MMMM YYYY') }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-5">
                    ...
                    <div class="relative" x-data="{ open: false }" @click.away="open = false">
                        <button @click="open = !open" 
                                class="relative h-9 w-9 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-400 hover:text-[#39A900] hover:bg-white transition-all cursor-pointer group shadow-sm">
                        ...
                        <div x-show="open"
                             ...
                             class="absolute right-0 mt-2 w-72 origin-top-right rounded-2xl bg-white shadow-2xl ring-1 ring-black/5 focus:outline-none z-50 overflow-hidden"
                             x-cloak>
                            
                            <div class="p-4 border-b border-slate-50 bg-slate-50/50">
                                <div class="flex items-center justify-between">
                                    <h3 class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Notificaciones</h3>
                                    @if($pendingLoansCount > 0)
                            ...
                            <div class="max-h-64 overflow-y-auto">
                                @if($pendingLoansCount > 0)
                                    <div class="p-4 group hover:bg-slate-50 transition-colors cursor-pointer border-b border-slate-50">
                                        <div class="flex gap-3">
                                            <div class="h-8 w-8 rounded-lg bg-orange-100 flex items-center justify-center flex-shrink-0 text-orange-600">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                                            </div>
                                            <div>
                                                <p class="text-xs font-bold text-slate-700 leading-tight mb-1">Solicitudes de Préstamo</p>
                                                <p class="text-[11px] text-slate-500 leading-snug">Tienes <span class="text-[#39A900] font-bold">{{ $pendingLoansCount }}</span> préstamos esperando tu aprobación.</p>
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    <div class="p-8 text-center">
                                        <div class="h-12 w-12 rounded-full bg-slate-50 flex items-center justify-center mx-auto mb-3 text-slate-300">
                                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                                        </div>
                                        <p class="text-xs font-bold text-slate-400">No hay notificaciones nuevas</p>
                                    </div>
                                @endif
                            </div>
                            ...
                            @if($pendingLoansCount > 0)
                                <div class="p-2 bg-slate-50">
                                    <a href="{{ route('admin.prestamos.index') }}" class="block w-full py-2 text-center text-[10px] font-black text-[#39A900] hover:bg-white rounded-xl transition-all uppercase tracking-widest border border-transparent hover:border-slate-100">
                                        Gestionar Préstamos
                                    </a>
                                </div>
                            @endif
                    ...
                    <div class="flex items-center gap-3 pl-5 border-l border-slate-100">
                        <div class="text-right hidden sm:block">
                            <p class="text-[13px] font-black text-[#00324D] leading-tight">{{ Auth::user()->name }}</p>
                        ...
                        <div class="h-10 w-10 bg-gradient-to-br from-[#39A900] to-green-600 rounded-xl flex items-center justify-center text-white font-black text-lg shadow-lg border-2 border-white transition-transform hover:scale-110 cursor-pointer">
            ...
            <main class="flex-1 overflow-y-auto p-4 bg-gray-50">
                {{-- Flash Messages --}}
                @if(session('success'))
                    <div class="mb-2 bg-white border-l-4 border-[#39A900] text-[#00324D] p-3 rounded-xl shadow-sm flex items-center gap-4 group transition-all animate-fade-in-down">
                ...
                @endif
                @if(session('error'))
                    <div class="mb-2 bg-white border-l-4 border-rose-500 text-[#00324D] p-3 rounded-xl shadow-sm flex items-center gap-4 group transition-all animate-fade-in-down">
