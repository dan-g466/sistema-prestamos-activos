<x-admin-layout>
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-2">
        ...
        <div class="flex items-center gap-2 w-full md:w-auto">
            <button onclick="downloadPDF('{{ route('admin.reportes.pdf') }}')" id="downloadBtn" class="bg-white border-2 border-rose-600/10 text-rose-600 hover:border-rose-600 hover:bg-rose-50 font-black py-1.5 px-4 rounded-xl shadow-sm transition-all duration-300 flex items-center gap-2 group text-[10px] uppercase tracking-widest">
                <svg id="downloadIcon" class="w-3.5 h-3.5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <svg id="loadingIcon" class="w-3.5 h-3.5 animate-spin hidden" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                <span>Exportar</span>
            </button>
