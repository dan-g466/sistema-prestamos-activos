                    ...
                    <tbody class="bg-white divide-y divide-slate-100">
                        @forelse ($usuarios as $usuario)
                            <tr class="hover:bg-slate-50/50 transition-colors group/row text-[11px]">
                                ...
                                <td class="px-6 py-2">
                                    <div class="font-bold text-[#00324D]">{{ $usuario->email }}</div>
                                    <div class="text-[9px] text-slate-400 mt-0.5">{{ $usuario->telefono ?? 'Sin teléfono' }}</div>
                                </td>
                                <td class="px-6 py-2">
                                    <span class="text-[9px] font-mono font-black text-[#39A900] bg-green-50 px-2 py-0.5 rounded-lg border border-green-100">
                                        {{ $usuario->documento }}
                                    </span>
                                </td>
